...
import com.blog.content.idempotency.WriteIdempotencyService;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    @Autowired
    private com.blog.content.mapper.ArticleMapper articleMapper;
    @Autowired
    private NotificationProducer notificationProducer;
    @Autowired
    private CurrentUserService currentUserService;
    @Autowired
    private com.blog.content.service.UserProfileLookupService userService;
    @Autowired
