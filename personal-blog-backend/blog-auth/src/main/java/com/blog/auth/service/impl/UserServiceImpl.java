...
import com.blog.auth.mapper.UserProfileMapper;
...
import com.blog.auth.service.FileStorageService;
...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    private ChatProfileBroadcastService chatProfileBroadcastService;
    ...
    public UserProfileVo updateProfile(Long userId, UpdateProfileRequest request) {
        ...
        UserProfileVo result = toProfile(user, profile);
        try {
            chatProfileBroadcastService.broadcastProfileUpdate(userId, result.getNickname(), result.getAvatar());
