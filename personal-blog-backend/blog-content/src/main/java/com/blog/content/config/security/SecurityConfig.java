    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/user/{id:\\d+}/social-card").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/user/timeline").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/sign/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/sign/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/user/points").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/profile/visitors").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/profile/visit/**").authenticated()
